...
#전체적으로 과소적합되어 있음 -> 선형회귀의 한계

#y = a*x^2 + b*x + c -> 2차 방정식
...
#coef_ = 특성에 대한 계수, intercept_ = y절편
print(lr.coef_, lr.intercept_) #[  1.01433211 -21.55792498] 116.05021078278259
#a = 1.01433211, b = -21.55792498, c = 116.05021078278259
#y = 1.01 * 길이^2 -21.6 * 길이 + 116.05
...
plt.plot(point, 1.01 * point ** 2 - 21.6 * point + 116.05)#결국엔 직선 여러개가 모여서 2차함수 모양을 띈다
